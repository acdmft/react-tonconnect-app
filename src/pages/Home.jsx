...
const Home = () => {
  ...
  return (
    <div className="container mx-auto p-4 lg:w-1/2 md:w-2/3 sm:w-full">
      <div className="my-6">
        <h1 className="flex items-center justify-center h-64 text-6xl jolly-lodger-regular leading-normal sm:text-5xl md:text-9xl font-bold mb-8 text-center">
          <span>FLYING FOXES CRYPTO</span>
        </h1>
        <h2 className="jolly-lodger-regular uppercase text-4xl md:text-7xl font-semibold text-center mt-48 mb-8">
          {t('home.heading1')}
        </h2>
        {/* <p className="text-lg text-rose-500">{t('welcome')}</p> */}
        <p className="fredoka-regular tracking-wide sm:text-lg md:text-2xl text-gray-600 text-justify">
          {t('home.paragraph1')}
        </p>
      </div>
      <div className="mb-8">
        <h3 className="jolly-lodger-regular uppercase text-4xl md:text-7xl font-semibold text-center mt-24 mb-8">
        {t('home.heading2')}
        </h3>
        <p className="fredoka-regular tracking-wide sm:text-lg md:text-2xl text-gray-600 text-justify">
        {t('home.paragraph2')}
        ...
        <p className="fredoka-regular tracking-wide sm:text-lg md:text-2xl  text-gray-600 text-justify mt-8">
          Believe in Flying Fox Crypto. Believe in you.
        </p>
      </div>
      <div className="mb-8">
        <h2 className="jolly-lodger-regular uppercase text-4xl md:text-7xl font-semibold mb-2 text-center text-center mt-24 mb-8">
        {t('home.heading5')}
        </h2>
        <p className="fredoka-regular tracking-wide sm:text-lg md:text-2xl  text-gray-600 text-justify">{t('home.paragraph5.part1')}
